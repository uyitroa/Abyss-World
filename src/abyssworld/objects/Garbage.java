...
public class Garbage extends GameEntity{
	...
	public void show() {
		...
		GL11.glBegin(GL11.GL_QUADS);
	        ...
	        GL11.glVertex2f(this.getX() + textTure.getTextureWidth(),this.getY());
	        GL11.glTexCoord2f(1,1);
	        GL11.glVertex2f(this.getX() + textTure.getTextureWidth(),this.getY() + textTure.getTextureHeight());
	        GL11.glTexCoord2f(0,1);
	        GL11.glVertex2f(this.getX(), this.getY() + textTure.getTextureHeight());
	    GL11.glEnd();
	}
